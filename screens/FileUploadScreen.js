  ...
  return (
    <View style={styles.mainBody}>
      <View>
        ...
        <Image source={require('/Users/gimsehan/Develop/React_class/KusitsmGip/image/그림1.png')} style={{width: width ,height: 220, alignItems: 'center'}}/>
        <Text
          style={{
            fontSize: 14,
            marginTop: 10,
          ...
          {'\n'}
          4. 카카오톡 리스트에 뜨는 파일을 선택한다?? (이거맞는지 확인좀)
        </Text>
      </View>
      <TouchableOpacity
